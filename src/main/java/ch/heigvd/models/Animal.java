...
public class Animal {
  ...
  public boolean equals(Object o) {
    ...
    return number == animal.number
        && java.util.Objects.equals(frenchName, animal.frenchName)
        && java.util.Objects.equals(latinName, animal.latinName)
        && group == animal.group;
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(number, frenchName, latinName, group);
  }
}
