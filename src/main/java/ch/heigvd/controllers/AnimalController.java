...
public class AnimalController {
  ...
  // Délégation de la logique métier à la couche logic
  private final AnimalLogic logic;
  ...
  public void getAll(Context ctx) {
    ...
    returnWithEtag(ctx, logic.getAll(frenchName, latinName, group));
  }

  public void getOne(Context ctx) {
    int number = Integer.parseInt(ctx.pathParam("number"));
    returnWithEtag(ctx, logic.getOne(number));
  }
  ...
  private void returnWithEtag(Context ctx, Object result) {
    String etag = String.valueOf(result.hashCode());
